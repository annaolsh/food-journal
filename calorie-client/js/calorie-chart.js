$(document).ready(function(){
  ...
  $.ajax({
    ...
    success: function(data){
      var newArray = []
      // var changeType = userObj.user_id
      var userValueForChart = data.find(function(userObj){
        return $('#hiddenUserId').val() === (userObj.user_id).toString()
      })
      console.log("Are you happy Daniel?")
      console.log(userValueForChart)
